...
const OPCIONES: { valor: Clasificacion; texto: string; activo: string }[] = [
  { valor: "mth", texto: "De MTHosting", activo: "border-emerald-600 bg-emerald-950 text-emerald-300" },
  { valor: "propietario", texto: "Del propietario", activo: "border-sky-700 bg-sky-950 text-sky-300" },
  { valor: "sin_clasificar", texto: "Sin decidir", activo: "border-amber-600 bg-amber-950/40 text-amber-300" },
];
