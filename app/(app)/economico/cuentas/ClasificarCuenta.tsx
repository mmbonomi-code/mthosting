...
const OPCIONES: { valor: Clasificacion; texto: string; activo: string }[] = [
  { valor: "mth", texto: "De MTHosting", activo: "border-exito bg-exito-soft text-exito-text" },
  { valor: "propietario", texto: "Del propietario", activo: "border-dato-borde bg-dato-soft text-dato-text" },
  { valor: "sin_clasificar", texto: "Sin decidir", activo: "border-aviso bg-aviso-soft/40 text-aviso-text" },
];
