    ...
    <main className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center gap-6 px-4 py-16">
      ...
      <form action={enviar} className="flex flex-col gap-3">
        <input
          ...
          placeholder="••••"
          className="h-14 rounded-xl border border-borde-control bg-elevada text-center text-2xl tracking-[0.5em] text-tinta outline-none focus:border-primary"
        />
      ...
      <Link href="/" className="text-center text-sm text-tinta-etiqueta hover:text-tinta-suave">
        Volver al inicio
      </Link>
    </main>
  );
