<!-- ANTECEDENTE, NO VIGENTE. Desde el 22/09/2026 la identidad es el tema
     oscuro de docs/IDENTIDAD-VISUAL.md. Esto queda como referencia del logo,
     la tipografía, la lógica de estados y la paleta clara, por si se retoma. -->
<!-- ------------------------------------------------------------------------
